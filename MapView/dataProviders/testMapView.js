...
(function() {
    var provider = app.data.testMapView = new Everlive({
            offlineStorage: true,
            appId: 'yzyhs07edprf455q',
            scheme: 'https',
            authentication: {
                persist: true
            }
        }),
        accessTokenCacheKey = 'testMapView_access_token',
...
// START_CUSTOM_CODE_testMapView
// Add custom code here. For more information about custom code, see http://docs.telerik.com/platform/screenbuilder/troubleshooting/how-to-keep-custom-code-changes

// END_CUSTOM_CODE_testMapView